  ...
  return (
    <div className="py-20 w-full" id="experience">
      ...
      <div className="w-full mt-12 grid lg:grid-cols-4 grid-cols-1 gap-10">
        ...
        <Dialog open={isFirstOpen} onOpenChange={setIsFirstOpen}>
          <DialogContent className="max-w-4xl">
            <DialogHeader>
              <DialogTitle className="text-center text-2xl text-bold"></DialogTitle>
            </DialogHeader>
            <MovingDiv
        ...
        <Dialog open={isSecondOpen} onOpenChange={setIsSecondOpen}>
          <DialogContent className="max-w-4xl">
            <DialogHeader>
              <DialogTitle className="text-center text-2xl text-bold"></DialogTitle>
            </DialogHeader>
        ...
        <Dialog open={isThirdOpen} onOpenChange={setIsThirdOpen}>
          <DialogContent className="max-w-4xl">
            <DialogHeader>
              <DialogTitle className="text-center text-2xl text-bold"></DialogTitle>
            </DialogHeader>
