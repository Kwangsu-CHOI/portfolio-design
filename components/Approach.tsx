...
const Approach = () => {
  ...
  const descF =
    "Distinction Avg ++ \n Focused on Data Science and UX/UI \n Published paper on ENASE 2022. (Topic: Developing Accessible eHealth Portals: A Human-centred Approach) \n Participated in the thesis; A Human-centric Accessible eHealth Booking Web Portal. \n Also, finished subjects related to Data Science: MongoDB & Cassandra, R, SQL, and Cypher Query Language for Neo4j.";
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        ...
        >
          <CanvasRevealEffect
            ...
            containerClassName="bg-emerald-900 opacity-60 rounded-3xl overflow-hidden"
          />
        </Card>
        <Card
        ...
        >
          <CanvasRevealEffect
            ...
            containerClassName="bg-pink-900 opacity-60 rounded-3xl overflow-hidden"
            colors={[
        ...
        >
          <CanvasRevealEffect
            animationSpeed={3}
            containerClassName="bg-sky-600 opacity-60 rounded-3xl overflow-hidden"
            colors={[[125, 211, 252]]}
          />
        </Card>
      </div>
