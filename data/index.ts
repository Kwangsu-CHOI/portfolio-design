...
export const projects = [
  ...
  },
  {
    ...
    des: "Fully responsive MERN full stack blog application. Full CRUD with admin dashboard that provide editing posts, comments & replies, user profile, etc. ",
    img: "/p4.svg",
  ...
  },
  {
    ...
    des: "AI integrated Block based note App. Seamless real-time collaboration with others! Full stack app using NextJs, Firebase, Tailwind.",
    img: "/p7.svg",
    iconLists: ["/next.svg", "/tail.svg", "/ts.svg", "/supabase.png"],
    link: "https://ksnote-production.up.railway.app",
    sort: "FULL STACK",
  },
  {
    id: 6,
